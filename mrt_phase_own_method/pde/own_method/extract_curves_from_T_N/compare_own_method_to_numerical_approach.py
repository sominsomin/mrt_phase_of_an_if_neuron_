...
from mrt_phase_own_method.pde.own_method.extract_curves_from_T_N.extract_curves import get_curve_for_T_N
from config import equation_config
from mrt_phase_algorithmic.isochrones.plot_isochrones.plot_util import load_isochrones, plot_isochrones
