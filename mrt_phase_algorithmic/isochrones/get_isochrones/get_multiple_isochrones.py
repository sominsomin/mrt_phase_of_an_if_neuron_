...
from mrt_phase_algorithmic.src.Isochrone.isochrone_util import get_isochrone
...
if TYPE == DataTypes.TIMESERIES_TYPE:
    ...
    from mrt_phase_algorithmic.isochrones.get_isochrones.timeseries_grid_config import \
        isochrone_config, init_config
